        ...
        <div class="bg-white text-slate-900 rounded-2xl shadow-2xl p-8 md:p-12 space-y-8 border border-slate-200">
            ...
            <div class="grid grid-cols-3 gap-6 text-center text-xs border-t-2 border-slate-200 pt-10 mt-8">
                <div>
                    ...
                    <div class="text-[11px] text-slate-500">Prepared By</div>
                </div>

                <div>
                    <div class="h-12 border-b border-slate-300 mb-2"></div>
                    <div class="font-bold text-slate-900">{{ $quotation->approved_by ?? 'Authorized Manager' }}</div>
                    <div class="text-[11px] text-slate-500">Approved By</div>
                </div>
                ...
                <div class="flex flex-col items-center justify-end">
                    ...
                    <div class="text-[11px] text-slate-500 font-semibold">Authorized Signature</div>
                </div>
            </div>
        </div>
    </div>
